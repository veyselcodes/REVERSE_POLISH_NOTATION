...
HD_PWD='C:/Users/recep/Desktop/Transvaro/RFN/RFN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reversePolishNotation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reversePolishNotation.tcl
